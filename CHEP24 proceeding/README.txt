...
The WoC document class is derived from the LaTeX2e article.cls
...
CONTENTS
  ...
  doiEDPS.sty	   DOI style to add hyperlink on DOI numbers
  cuted.sty		   Style to manage twocolumn option

  additional-styles.zip	For old LaTeX version, install these styles in  your local directory.
...
Alternatively to reading the entire documentation, it is also possible to proceed by merely filling out the template and then looking up additional commands as needed.
